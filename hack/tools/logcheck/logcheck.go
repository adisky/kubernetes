...
func checkForFunctionExpr(fun ast.Expr, pass *analysis.Pass) {
	...
	if selExpr, ok := fun.(*ast.SelectorExpr); ok {
		...
		// for nested function cases klog.V(1) scenerios
...
func isUnstructured(fName string) bool {
	...
	unstrucured := []string{"Infof", "Info", "Infoln", "InfoDepth", "Warning", "Warningf", "Warningln", "WarningDepth", "Error", "Errorf", "Errorln", "ErrorDepth", "Fatal", "Fatalf", "Fatalln", "FatalDepth"}
